    ...
    son_mary_meeting = {
      ...
      run = function(self, rails, c)
        ...
        if api.saving_throw("wis", 18) then
          ...
          api.narration("Оно закончится не скоро.")
          api.narration("——————")
          api.narration("————")
          api.narration("—————")
    ...
    son_mary_alcohol_2 = {
      ...
      run = function(self, rails, c)
        ...
        if self._first_time then
          ...
          api.notification("Ты хочешь вернуться к своим обязанностям.", true)
          ...
          elseif chosen_option_1 == 2 then
            ...
            while true do
              ...
              elseif chosen_option_2 == 5 then
                ...
                api.line(c.son_mary, "Они обрекли свои рода на самые страшные из проклятий, лишь затем, чтобы увидеть мою слабость, мои мучения.")
          ...
          elseif chosen_option_1 == 4 then
            while true do
              ...
              elseif chosen_option_2 == 2 then
                ...
                api.line(c.player, "А?")
                api.line(c.son_mary, "Обычно в этих местах хранится самое сокровенное")
