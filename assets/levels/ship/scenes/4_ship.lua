  ...
  return {
      ...
      run = function(self, rails, c)
        ...
        while true do
          ...
          elseif chosen_option == 2 then
            api.narration("Глубого встрявшая бритва имеет невероятную заточку.")
...

    {
      ...
      _contents = {
        ...
        {250, "На дне сундука спрятался кошелёк с фотографией дварфа в форме Экс-Адмирала — внутри стопка увесистых купюр с портретами Святых; 20 лет назад это было целое состояние."},
