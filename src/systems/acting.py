...
@create_system
def act(
    actor: 'act', level: 'grids', infosphere: 'information_grid',
    hades: 'entities_to_destroy', genesis: 'entities_to_create'
):
    if actor.act is None: return
    actor.act.execute(actor, level, infosphere, hades, genesis)
