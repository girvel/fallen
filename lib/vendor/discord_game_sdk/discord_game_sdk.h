...
struct IDiscordOverlayManager {
    ...
    enum EDiscordResult (*init_drawing_dxgi)(struct IDiscordOverlayManager* manager, void* swapchain, bool use_message_forwarding);
    void (*on_present)(struct IDiscordOverlayManager* manager);
    void (*forward_message)(struct IDiscordOverlayManager* manager, void* message);
